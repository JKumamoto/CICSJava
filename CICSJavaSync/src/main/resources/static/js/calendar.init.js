...
const getInitialView=()=>768<=window.innerWidth&&window.innerWidth<1200?"timeGridWeek":window.innerWidth<=768?"listMonth":"dayGridMonth",

getDateValue=(document.addEventListener("DOMContentLoaded",function(){
	...
	l=null,d=document.getElementById("drop-remove"),
	...
	r=new FullCalendar.Calendar(a,{
		...
		dateClick:function(e){
			u(),document.getElementById("event-id").value=defaultEvents.length+1;
			var t=new Date;
			let n=e.date;
			e={
				dateFormat:"Y-m-d H:i:S",
		...
		eventClick:function(e){
			if(l=e.event,e.event.url)
				return!1;
			var e=l.title,
			t=void 0===l.extendedProps.description?"No Description":l.extendedProps.description,
			n=void 0===l.extendedProps.location?"No Location":l.extendedProps.location,
			d=l.id;
			document.getElementById("view-event-modal-title").innerHTML=e,
			document.getElementById("view-event-dates").innerHTML=eventDates(l.start,l.end),
	...
	document.body.contains(e)&&e.addEventListener("click",function(){
		u(),
		l=null,
		addEventButton.removeAttribute("hidden"),
		updateEventButton.setAttribute("hidden",!0),
	...
	r.render(),
	document.body.contains(t)&&t.addEventListener("click",function(e){
		var t=document.getElementById("selected-event-id").value;
		confirm("Are you sure want to delete this event ?")&&(r.getEventById(t).remove(),viewEventModal.hide())
	}),
	document.body.contains(n)&&n.addEventListener("click",function(e){
		updateEventButton.removeAttribute("hidden"),
		addEventButton.setAttribute("hidden",!0);
		var t=l.id,
		n=l.title,
		d=void 0===l.extendedProps.description?"No Description":l.extendedProps.description,
		a=void 0===l.extendedProps.location?"No Location":l.extendedProps.location,
		i=void 0===l.start||null===l.start?"-":l.start,o=void 0===l.end||null===l.end?null:l.end,
		n=(document.getElementById("add-edit-event-modal-title").innerHTML="Edit - "+n,
			...
			document.getElementById("event-category").value=l.classNames,
			viewEventModal.hide(),
			document.getElementById("eventStart").flatpickr().clear(),
			document.getElementById("eventEnd").flatpickr().clear(),
			{
				dateFormat:"Y-m-d H:i:S",
				defaultDate:[new Date(i)],enableTime:!0
			}),
			n=(flatpickr("#eventStart",n).redraw(),
			{
				dateFormat:"Y-m-d H:i:S",
				defaultDate:[new Date(o)],enableTime:!0
			});
			flatpickr("#eventEnd",n).redraw(),
			addEditEventModal.show()
		}),
	document.body.contains(formEvent)&&formEvent.addEventListener("submit",function(e){
		e.preventDefault();
		...
		l?(
			...
			defaultEvents[o]&&(defaultEvents[o].title=e,
				defaultEvents[o].start=a,
				defaultEvents[o].end=i,
				defaultEvents[o].allDay=!1,
				defaultEvents[o].className=t,
				defaultEvents[o].description=n,defaultEvents[o].location=d
			),
		r.render()):(o={
				...
				className:t,description:n,location:d,allDay:!1
			},
			r.addEvent(o),
...
e=>{
	...
	n=""+e.getDate(),
	d=e.getFullYear(),
	a=e.getHours()%12||12,e=e.getMinutes();
	return t.length<2&&(t="0"+t),
	[(n=n.length<2?"0"+n:n)+" "+t,d+" "+a+":"+("0"+e).slice(-2)+" "+(12<=a?"PM":"AM")].join(",")
}),
eventDates=(e,t)=>{
	e=new Date(e.getFullYear(),e.getMonth(),e.getDate(),e.getHours(),e.getMinutes()),
	t=null==t?null:new Date(t.getFullYear(),t.getMonth(),t.getDate(),t.getHours(),t.getMinutes());
	return e<t?"<b>From :</b> "+getDateValue(e)+" <br/><b>To :</b>"+getDateValue(t):getDateValue(e)
};